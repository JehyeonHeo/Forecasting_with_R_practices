...
autoplot(retail.ts) +
  autolayer(retail.ts_arima.2.1.0.1.0.0.12$fitted)
# The residuals of the last 2 peak points became smaller.

checkresiduals(retail.ts_autoarima2)
# But the residuals aren't still like white noise. But I'll use this model in forecasting because these residuals are more like white noise than the model above.
