...
# When I used Holt-Winters' method with damped option, I couldn't beat seasonal naive approach. But when I used the method with damped option, I could get almost same accuracy even if I couldn't beat it. 
